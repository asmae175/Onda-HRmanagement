...
<div class="container">
  <h2 style="color:#000080;">Liste des employés supprimés</h2>
   ...
   $req=$bd->prepare('SELECT * FROM reduction');
$req->execute();
$c=1;
while($requete=$req->fetch())
  {if ($c%2==0)
    ...
    echo "<td>".$requete['matricule']."</td>
        ...
        <td>".$requete['sexe']."</td>
        <td>".$requete['date_de_naissance']."</td>
        ...
        <td>".$requete['type_de_depart']."</td>
        <td>".$requete['date_de_depart']."</td>";
